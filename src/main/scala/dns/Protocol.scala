...
object OpCode:
  def fromInt(code: Int): OpCode = code match
    case 0 => Query
    case 1 => IQuery
    case 2 => Status
    case 4 => Notify
...
object ResponseCode:
  def fromInt(code: Int): ResponseCode = code match
    case 0 => NoError
    case 1 => FormatError
...
object RecordType:
  def fromInt(code: Int): RecordType = code match
    case 1 => A
    case 2 => NS
    case 5 => CNAME
    case 6 => SOA
...
object RecordClass:
  def fromInt(code: Int): RecordClass = code match
    case 1 => IN
    case 3 => CH
    case 4 => HS
    case 255 => ANY
...
object RecordData:
  def ipv4(value: String): RecordData.A =
    A(InetAddress.getByName(value).asInstanceOf[Inet4Address])

  def ipv6(value: String): RecordData.AAAA =
    AAAA(InetAddress.getByName(value).asInstanceOf[Inet6Address])
...
final case class ResourceRecord(
  ...
  def recordType: RecordType = data match
